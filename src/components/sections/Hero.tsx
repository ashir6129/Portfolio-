        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-16 px-4">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute w-[500px] h-[500px] bottom-[10%] left-[10%] rounded-full"
                    style={{
          ...
          `,
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <motion.p
                            ...
                            className="text-base sm:text-lg text-[var(--text-tertiary)] max-w-xl mx-auto lg:mx-0 mb-8"
                        >
                            BS Computer Science student at{" "}
                            <span className="text-violet-400 font-medium">FAST NUCES</span>.
                            I build elegant, performant, and user-centric applications.
                        </motion.p>
                        ...
                        >
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-3 bg-[var(--bg-card)] hover:bg-[var(--bg-card-hover)] rounded-xl border border-[var(--border-subtle)] hover:border-violet-500/50 transition-all duration-300 group"
                            >
                ...
                >
                    <p className="text-sm text-[var(--text-muted)] mb-6 uppercase tracking-wider">Technologies I work with</p>
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        {[
                            ...
                            <motion.div
                                ...
                                className="px-4 py-2 bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-lg hover:border-violet-500/50 transition-colors"
                            >
